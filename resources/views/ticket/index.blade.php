    ...
    <script type="text/x-template" id="grid-template">
        <div class="row">
            ...
            <tr v-for="row in data">
                ...
                <td>
                    <a href="/ticket/@{{row.Id}}">@{{row.Name}}</a>
                </td>
                <td>
                    @{{row.Created | formatDate}}
                </td>
                <td ><a href="/ticket/@{{row.Id}}/edit"> <button type="button" class="btn btn-default">Edit</button></a></td>
            </tr>
            </tbody>
        </table>
                    </div>
...
@section('scripts')
    ...
    <script>
                ...
                getData: function (page) {
                    ...
                    switch (page){
                        ...
                        case this.last_page_url :
                            ...
                            getPage = 'api/ticket-vue?keyword=' + this.query + '&column=' + this.sortKey + '&direction=' + this.sortOrder;
                        ...
                        case this.go_to_page :
                            ...
                            if( this.go_to_page != '' && this.go_to_page <= parseInt(this.last_page)){
                                ...
                                getPage = 'api/ticket-vue?page=' + this.go_to_page + '&column=' + this.sortKey + '&direction=' + this.sortOrder + '&keyword=' + this.query;
                        ...
                        default :
                            ...
                            getPage = 'api/ticket-vue?page=' + page + '&column=' + this.sortKey + '&direction=' + this.sortOrder + '&keyword=' + this.query;
                    ...
                    if (this.query == '' && getPage != null){
                        ...
                        if (getPage != null){
                            ...
                            this.first_page_url = 'api/ticket-vue?page=1&keyword=' +this.query;
                            this.last_page_url = 'api/ticket-vue?page=' + this.last_page + '&keyword=' +this.query;
                            this.current_page = data.current_page;
        ...
        var ticket = new Vue({
            ...
            components: 'ticket-grid',

            methods: {
                loadData: function () {
                    $.getJSON('api/ticket-vue', function (data) {
                        ...
                        this.prev_page_url = data.prev_page_url;
                        this.current_page = data.current_page;
                        this.first_page_url = 'api/ticket-vue?page=1';
                        this.last_page_url = 'api/ticket-vue?page=' + this.last_page;
                        this.setPageNumbers();
                    }.bind(this));
                },
