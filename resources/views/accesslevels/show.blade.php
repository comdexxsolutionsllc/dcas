...
<div class="panel panel-default">
    <div class="panel-heading">
        View Accesslevel    </div>

    <div class="panel-body">
                
        <form action="{{ url('/accesslevels') }}" method="POST" class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" name="access_level" id="access_level" class="form-control" value="{{$model['access_level'] or ''}}" readonly="readonly">
            </div>
        </div>
