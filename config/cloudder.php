...
return [
    ...
    */
    ...
    'cloudName'  => env('CLOUDINARY_CLOUD_NAME', 'fiberhopllc'),
    ...
    'apiKey'     => env('CLOUDINARY_API_KEY', '594451113395747'),
    'apiSecret'  => env('CLOUDINARY_API_SECRET', 'mbz3tLEgrf5f5j7UaxMLN0CI54Q'),
